...
VALUES (150, 100, 1, 5, '2025-01-20', 'Курьер');
...
DELETE FROM ЗАКАЗЫ WHERE id_заказа = 150;
...
BEGIN
    ...
    BEGIN
        INSERT INTO ЗАКАЗЫ (id_заказа, id_клиента, id_товара, Количество, Дата_поставки, Вид_доставки)
        SELECT id_заказа, id_клиента, id_товара, Количество, Дата_поставки, Вид_доставки FROM INSERTED;
    END
END;
GO
drop trigger trg_ЗапретОтрицательногоКоличества
